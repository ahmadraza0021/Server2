...
//this middleware will be called for all the routes
// custom middleware to check token and password from query
let mypass = "12345";
let myToken = "12345";
let CheckToken = (req, res, next) => {
...
// this is how to use middleware on specific route
// app.get('/news',checkToken,(req, res) => { //http://localhost:4000/news
//     res.send({status: 1, msg: "News API"});
// });
