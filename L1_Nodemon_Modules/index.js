...
//after installing nodemon we will run this command to run the file => nodemon index.js  after that we will not need to run the file again and again then we set nodemon index.js in package.json as script => "start": "nodemon index.js" now run command in terminal => npm start
